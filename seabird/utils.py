...
def sampledata(filename=None, dtype=None):
    ...
    filesdb = {
        'PIRA001.cnv': {
            'dtype': "CTD", 'md5': "5ded777144300b63c8775b1d7f033f92"},
        'dPIRX003.cnv': {
            'dtype': "CTD", 'md5': "4b941b902a3aea7d99e1cf4c78c51877"},
        'dPIRX010.cnv': {
            'dtype': "CTD", 'md5': "8691409accb534c83c8bd412afbdd285"},
        'Hotin.cnv': {
            'dtype': "CTD", 'md5': "814dc769c0775327bbe5b0f489dfb571"},
        'missing_whitespace.cnv': {
            'dtype': "CTD", 'md5': "c1f00cebb5f00f6aaebc316bac3fd86a"},
        'SK287_CTD05.cnv': {
    ...
    if filename is None:
        ...
        for f in filesdb:
            print(f)
            download_file(outputdir=outputdir,
        ...
        download_file(outputdir=outputdir,
                      url=os.path.join(src,
                                       filesdb[filename]["dtype"],
                                       filename),
                      filename=filename,
