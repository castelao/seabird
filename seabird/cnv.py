...
class CNV(object):
    ...
    def __split_row(row):
        """
        Splits rows based on position. Seabird cnv files delimit fields after 11 positions
        :param row: string representation of a row that needs to be split into fields
